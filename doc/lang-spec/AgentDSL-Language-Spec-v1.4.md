...
| `customSetting`| 自定义模型参数（键值对）     | `String, Object` | 无            |
...
| Provider | 支持参数 | 说明 |
|----------|---------|------|
| **OpenAI** | 通用支持 | 所有参数通过 `customParameters` 传递 |
| **Claude** | 通用支持 | 所有参数通过 `customParameters` 传递 |
| **DeepSeek** | 通用支持 | OpenAI 兼容接口 |
| **Kimi/Moonshot** | 通用支持 | OpenAI 兼容接口 |
| **Doubao** | 通用支持 | OpenAI 兼容接口 |
| **Qwen** | 通用支持 | OpenAI 兼容接口 |
| **Zhipu/GLM** | 通用支持 | OpenAI 兼容接口 |
| **Minimax** | 通用支持 | OpenAI 兼容接口 |
